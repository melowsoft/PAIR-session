      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between md:items-center">
        ...
        <div className="flex flex-wrap items-center gap-3">
            ...
            <button
                ...
                aria-label={`Sort by popularity ${sortOrder === 'desc' ? 'ascending' : 'descending'}`}
            >
                ...
                <span className="bg-gray-200 text-gray-600 px-1.5 py-0.5 rounded text-xs uppercase">{sortOrder}</span>
            </button>
